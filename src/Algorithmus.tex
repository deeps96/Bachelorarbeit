...
Auf die konkrete Funktionsweise des URL-Cleaners wird im nachfolgenden nicht weiter eingegangen, da der Fokus dieser
Arbeit auf dem Parser liegt.
...
Dieses Rauschen entsteht dadurch, dass für die gecrawlten HTML-Dokumente nun potenziell viele Daten extrahiert werden,
bei denen nicht mehr bekanntist, welche extrahierten Informationen korrekt oder falsch sind.
