...
Ca. die Hälfte der Nichtübereinstimmungen besitzen eine Distanz von $\leq 3$ und sind auf Kodierungsfehler, sowie
unterschiedliche Trennzeichen zurückzuführen.
Außerdem war es häufiger der Fall, dass der Preis um wenige Centbeträge von der Momentaufnahme der idealo-Daten
abwich.
Ein konkretes Beispiel ist zum Beispiel der extrahierte Wert ``jack-wolfskin'', welcher von dem gesuchten Wert ``Jack
Wolfskin'' um die Distanz $1$ abweicht.
