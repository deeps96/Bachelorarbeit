...
Der Tabelle kann man entnehmen, dass die beste Ergebnisse für die Parameter $SaS = 50$ und $F = 0.6$ erreicht werden.
...
Bei einer manuellen Kontrolle konnte ermittelt werden, dass oftmals Kodierungsfehler oder
unterschiedliche Trennzeichen eine Übereinstimmung verhindern.
Außerdem war es häufiger der Fall, dass sich der Preis um wenige Cent ändert und dieser von der Momentaufnahme der
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9 \textwidth]{resources/accuracy-and-precision-per-attribute.PNG}
